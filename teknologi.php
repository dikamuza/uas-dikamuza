        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="teknologi.php">Technology Posts</a></li>
                    <li class="nav-item"><a class="nav-link" href="gayahidup.php">Lifestyle Posts</a></li>
            ...
            <div class="col-md-8">
                ...
                <div class="pagination">
                    <?php if ($currentPage > 1): ?>
                        <a href="teknologi.php?page=<?= $currentPage - 1; ?>">&laquo; Previous</a>
                    <?php endif; ?>

                    <?php for ($page = 1; $page <= $totalPages; $page++): ?>
                        <a href="teknologi.php?page=<?= $page; ?>" <?= ($page === $currentPage) ? 'class="active"' : ''; ?>><?= $page; ?></a>
                    <?php endfor; ?>

                    <?php if ($currentPage < $totalPages): ?>
                        <a href="teknologi.php?page=<?= $currentPage + 1; ?>">Next &raquo;</a>
                    <?php endif; ?>
                </div>
            </div>
